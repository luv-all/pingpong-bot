...
상대편 끝선 중앙을 조준한다. 평소에는 발사기 높이 1.05m에서 6cm 감긴 자세로
...
시작부터 라켓을 발사기 높이 1.05m에서 임팩트 방향 반대로 6cm 감아 둔다. 공 검출 시
예측한 공의 x·y·z와 상대편 끝선 중앙 방향을 동시에 만족하는 임팩트 자세를 구하고,
같은 6cm 감김을 유지하며 높이·레일만 보정한 뒤 공 도착 시 최대 1.80m/s로 펴지게 한다.
0.06초 팔로스루 후에는
