...
예측 위치 뒤 최대 10cm에서 팔을 접어 정렬하고, 타격 0.25초 전에 백스윙 없이 j0~j3 직진 푸시를 시작한다. 타격 후에는 레일을 움직이지 않고 관절만 높은 역 U자 아치 자세로 복귀한다.
...
타격 0.25초 전에 접힌 정렬 자세에서 별도 백스윙 없이 j0~j3 직진 푸시를 시작한다. 10cm 전진 구간의 임팩트 목표 속도는 0.70m/s다. 임팩트 후 0.12초 팔로스루 뒤 리니어 레일은 현재 x에 두고 관절만 높은 역 U자 아치 자세로 복귀한다.
