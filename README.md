...
정렬 단계부터 15° 상향각과 상대 코트 3/4 중심 방향을 맞추고,
타격 직전에는 q2·q3를 함께 돌려 그 방향을 유지한다. 임팩트 후에도
...
전체 팔·레일 IK는 라켓 면을 15° 상향각으로 상대 코트 3/4 중심을 향하게 하며 예측 공 높이보다 1.5cm 높은 지점에 정렬한다. 타격 직전에는 q2·q3를 함께 돌려 그 방향을 유지한다.
...
타격 0.25초 전에 정렬 자세에서 q2·q3를 회전해 타격 시점 라켓 면을 15°·3/4 코트 중심에 맞추고, 임팩트 후 0.12초 팔로스루 후 현재 모드의 준비 자세로 복귀한다.
정렬 중이어도 q2·q3 스냅 명령이 관절 스트림을 선점하며, 관절 한계·토크·테이블 검사를 통과하지 못하면 스냅만 생략한다.
