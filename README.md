...
로봇은 물리 레일 양 끝에서 0.0705 m를 제외한 안전 범위(0.0705~1.4495 m) 안에서 정확한 중앙 준비 위치(0.760 m)와 준비 관절 자세로 바로 이동한다.
...
시작 시 레일 0.760m와 기본 관절각의 중립 자세를 만든다. 공 검출 시
...
AXL 보드 원점이 레일 중앙이며, 앱 안전 범위
`0.0705~1.4495 m`가 보드 범위 `0.6895~-0.6895 m`에 대응한다.
준비 위치는 정확한 중앙 `0.760 m`이며, 양쪽에 각각 `0.0705 m`의
안전 마진을 둔다.
