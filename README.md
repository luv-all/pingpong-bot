...
수평 법선 정렬 자세에서 q3 손목만 돌려 타격 시점 라켓 면을 25°로 만든다. 임팩트 후에도
...
예측 위치에 수평 법선으로 정지 정렬하고, 타격 0.25초 전에 q3 손목만 돌려 타격 시점에 라켓 면이 25° 위를 보게 한 뒤 중립 자세로 복귀한다.
...
전체 팔·레일 IK는 라켓 면을 수평 법선으로 둔 채 예측 공 높이보다 1.5cm 높은 지점에 먼저 정렬한다. 타격 직전에 q3 손목만 돌려 라켓 면을 수평 기준 25° 위로 맞춘다.
