...
상대편 끝선 중앙을 조준한다. 레일·조준과 관절 푸시를 거의 동시에 시작하고,
공 도착 시 속도가 최대가 되게 맞춘다. GUI sim도 같은 계산과 궤적 계획을 쓴다.
...
레일·조준과 거의 동시에 5cm 고정 푸시를 시작해 공 도착 시 최대 1.80m/s 목표 임팩트와
0.06초 팔로스루를 만들며, 적응형 전체 스윙·결선 랠리는 아직 지원하지 않는다. 이후
실기 보정 레일 준비 위치(0.710 m)와 준비 관절 자세로 자동 복귀한다.
