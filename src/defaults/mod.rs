...
pub use calib::{
    ...
    calibration_path, calibration_pending_path, clip_calibration_path, colormask_path,
    ensure_parent_dir,
};
...
pub use motion::{
    ...
    RACKET_DIRECTION_TOLERANCE_DEG, RACKET_SPEED_RATIO_TOLERANCE, RALLY_RETURN_SPEED_RATIO,
    RETURN_TO_CENTER_GROWTH,
...
mod tests {
    ...
    fn presets_validate() {
        ...
        assert!((ALIGNMENT_TARGET_HEIGHT_OFFSET_M - 0.045).abs() < 1e-12);
