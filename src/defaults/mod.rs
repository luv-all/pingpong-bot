...
pub use calib::{
    ...
    DEFAULT_COLORMASK_PATH, DEFAULT_DATA_DIR, DEFAULT_DETECT_STILLS_DIR,
    DEFAULT_DETECT_STILLS_MANIFEST, DEFAULT_FOV_Y_DEG, DEFAULT_STEREO_CAM_ROLES,
    ...
    colormask_path, detect_stills_dir, detect_stills_manifest_path, ensure_parent_dir,
};
...
pub use vision::{
    ...
    STILL_HIT_RADIUS_PX, camera_params_for, colormask_for, detector_for,
};
