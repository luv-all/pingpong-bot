...
pub(crate) fn scorer_params_from_calib(params: &Params, circularity: f64) -> Result<ScorerParams> {
...
fn ball_area_bounds(params: &Params) -> Result<(f64, f64)> {
...
mod tests {
    ...
    fn area_bounds_ordered_and_finite() {
        let params = Params::sim_layout(Id(0), 2);
