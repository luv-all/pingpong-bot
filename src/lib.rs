...
pub use camera::{
    ...
    PixelPickMouse, PixelPoint, PreviewAction, ResolvedCam, ResolvedStereoOffline, ShowBgrResult,
    SimCamera, StereoCamCliArgs, StereoClip, StereoOfflineArgs, StereoPairCliArgs, StreamPreset,
    TABLE_LANDMARK_COUNT, TableLandmark, TablePnpResult, ThreadedCapture, WorldGridParams,
    apply_grid_key, arducam_b0332, arrow_delta, calibrate_charuco, calibrate_table_pnp,
    destroy_window, detect_and_draw_charuco, display_fit_bounds, dlt_triangulate, draw_cam_label,
    draw_circle_px, draw_debug_lines, draw_help_lines, draw_pixel_loupe, draw_world_grid,
    draw_world_velocity, ensure_reproj_below, ensure_reproj_ok, fit_bgr_downscale, hstack_bgr,
    parse_fourcc, resolve_cams, resolve_clip_dir, resolve_clip_side, resolve_mono_offline,
    resolve_stereo_clip, resolve_stereo_offline, sample_at, show_bgr, table_landmark_mesh_edges,
    table_landmarks, triangulate_projections, triangulate_synced, triangulate_views, unscale_xy,
    upsert_camera,
};
pub use defaults::{
