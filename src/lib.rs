...
pub use camera::{
    ...
    PreviewAction, SimCamera, TABLE_LANDMARK_COUNT, TableLandmark, TablePnpResult,
    ...
    draw_pixel_loupe, draw_world_velocity, ensure_reproj_below, ensure_reproj_ok, hstack_bgr,
    sample_at, show_bgr, table_landmark_mesh_edges, table_landmarks, triangulate_projections,
    triangulate_synced, triangulate_views, upsert_camera,
};
pub use defaults::{
