...
pub struct Args {
    ...
    /// 실측 마운트는 0.935 (`defaults::rail_frame`); 스윕은 그 근방을 덮는다.
    #[arg(long, allow_hyphen_values = true, default_value_t = 0.86)]
    pub base_z_min: f64,
    #[arg(long, allow_hyphen_values = true, default_value_t = 1.00)]
    pub base_z_max: f64,
